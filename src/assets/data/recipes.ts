...
const recipes: Blog[] = [
	...
	{
		id: gen_id(),
		title: "Gochujang Kimchi Chicken Thighs",
		ingredients: [
			"4 chicken thighs",
			"2 tbsp gochujang",
			...
			"1 tsp salt",
			// Sides
			"Green onions, halved (for griddle cool zone)",
		...
		instructions: [
			"1. Dry and season: Pat chicken thighs really dry. Season both sides with salt and press flat.",
			"2. Make the glaze: Mix gochujang, kimchi brine, and sesame oil together in a small bowl.",
			"3. Sear skin-side down: Get griddle ripping hot, no oil. Place thighs skin-side down, don't touch. Press with spatula every couple minutes. Cook about 10 minutes.",
			"4. Flip and cook through: Flip to flesh side. Add smashed garlic to griddle alongside chicken. Cook about 8 minutes.",
			"5. Glaze and char: Flip back skin-side down. Spoon glaze over top, let caramelize. Watch it — gochujang burns fast. About 2 minutes.",
			"6. Griddle the kimchi: Push chicken aside. Sear kimchi directly on griddle until caramelized and smoky, about 3 minutes.",
			"7. Rest and serve: Rest chicken 5 minutes, serve with charred kimchi on top.",
			// Sides
			"Sides: Warm extra kimchi low and slow on the griddle cool zone, let edges lightly char. Lay green onion halves flat on cool zone, cook ~3 minutes until silky and sweet.",
			"Cucumber salad: Combine thinly sliced cucumber with rice vinegar, sesame oil, and a pinch of salt. Let sit 10 minutes before serving.",
		],
		notes: [
			"A fried egg on top tastes great and helps presentation.",
		],
		nutrition: [],
	},
	{
		"id": gen_id(),
		"title": "Southwest Smash Burger with Blue Corn & Pepper Jelly",
		"ingredients": [
			"ground beef patties",
			"pepper jack cheese",
			"bell pepper",
			...
			"brioche buns",
			"lime",
			"white american or monterey jack cheese",
		...
		"instructions": [
			...
			"Season beef balls generously with cumin, smoked paprika, garlic powder, and salt",
			"Place beef on griddle and smash flat immediately, cook 2-3 minutes until crust forms",
			"Flip patty, add pepper jack cheese, let melt",
			"Char bell pepper strips directly on griddle alongside patties",
			"Mash avocado with lime juice and salt",
			"Melt monterey jack with green chiles and a splash of milk in a small pan on the griddle for queso",
			"Toast brioche buns on the griddle",
			"Build: bun, patty with melted cheese, charred bell pepper, avocado mash, pepper jelly, pickled jalapeño, arugula, crumbled blue corn chips, top bun",
			"Serve with blue corn chips and queso on the side"
		],
		"notes": [
			"Smash the patty within the first 30 seconds on the griddle for maximum crust",
			"Pepper jelly goes on the bun not the patty so it doesn't burn",
			"Keep queso low and slow on the griddle so it doesn't break",
			"Crumble chips just before serving so they stay crunchy"
		],
		"nutrition": [
		]
	}
