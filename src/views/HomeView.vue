  ...
  <div class="content">
    <div class="center">
      <p class="body-text">
          ...
          representation of microservices connected by a service mesh. But I wanted
          something cheap and automatic and to figure out the hackiest way possible
          to basically do the same thing, so here we are. Enjoy!
      </p>
    </div>
  </div>
</template>
